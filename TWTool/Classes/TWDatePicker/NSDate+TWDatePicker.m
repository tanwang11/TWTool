...
@implementation NSDate (TWDatePicker)
...
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + TWDatePickerDate_HOUR * dHours;
...
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + TWDatePickerDate_MINUTE * dMinutes;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
- (BOOL) isSameWeekAsDate: (NSDate *) aDate
{
    ...
    return (fabs([self timeIntervalSinceDate:aDate]) < TWDatePickerDate_WEEK);
}
...
- (BOOL) isNextWeek
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + TWDatePickerDate_WEEK;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
...
{
    NSTimeInterval aTimeInterval = [self timeIntervalSinceReferenceDate] + TWDatePickerDate_HOUR * dHours;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
{
    NSTimeInterval aTimeInterval = [self timeIntervalSinceReferenceDate] + TWDatePickerDate_MINUTE * dMinutes;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
- (NSInteger) minutesAfterDate: (NSDate *) aDate
{
    ...
    return (NSInteger) (ti / TWDatePickerDate_MINUTE);
}
...
{
    NSTimeInterval ti = [self timeIntervalSinceDate:aDate];
    return (NSInteger) (ti / TWDatePickerDate_HOUR);
}
...
{
    NSTimeInterval ti = [self timeIntervalSinceDate:aDate];
    return (NSInteger) (ti / TWDatePickerDate_DAY);
}
...
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + TWDatePickerDate_MINUTE * 30;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
